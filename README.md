...
## localstack setup
* The localstack S3 buckets should be running at http://data-store-file-assets-test.s3.localhost.localstack.cloud:4566/ and http://data-store-failed-files-test.s3.localhost.localstack.cloud:4566/
